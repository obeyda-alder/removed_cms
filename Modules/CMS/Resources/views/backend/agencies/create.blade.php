...
@section('cms-component')
    <div class="cms-buttons-">
        <div class="page-title">{{ __('cms::base.agencies.new', [ 'agencies_type' => __('cms::base.agencies.'.strtoupper($agencies_type)) ]) }}</div>
    </div>
@endsection

@section('content')

<form class="forms-sample" method="POST" onsubmit="OnFormSubmit(event)" action="{{ route('cms::agencies::store', ['agencies_type' => $agencies_type]) }}">
    @csrf
