...
@section('cms-component')
    <div class="cms-buttons-">
        <div class="page-title">{{ __('cms::base.users.new', [ 'type' => __('cms::base.users.'.strtoupper($type)) ]) }}</div>
    </div>
@endsection

@section('content')

<form class="forms-sample" method="POST" onsubmit="OnFormSubmit(event)" action="{{ route('cms::users::store', ['type' => $type]) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group m-form__group phone_number">
                <label>
                    @lang('cms::base.users.fields.phone_number.label')
                </label>
                <div class="input-group">
                    <input id="search_for_user_input" dir="ltr" type="number" name="phone_number" class="form-control text-left" placeholder="@lang('cms::base.users.fields.phone_number.placeholder')" value="">
                ...
                <span class="m-form__help">
                    @lang('cms::base.users.fields.phone_number.help')
                </span>
            </div>
